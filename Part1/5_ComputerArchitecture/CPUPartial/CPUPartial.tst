...
load CPU.hdl,
output-file CPUPartial.out,
compare-to CPUPartial.cmp,
output-list time%S0.4.0 inM%D0.6.0 instruction%B0.16.0 reset%B2.1.2 outM%D1.6.0 writeM%B3.1.3 addressM%D0.5.0 DRegister[]%D1.6.1;
